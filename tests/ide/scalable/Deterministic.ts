...
import { changePreferences, commit, editBubbleSort, editClient, editContext, editMergeSort, editPolicy, editSortStrategy, openAboutPage, reloadPage, runTests, searchForWords, useTerminal } from './Scenarios';
